...
<head>
	...
	<script type="text/javascript" src="scripts/development-bundle/jquery-1.3.2.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/ui.core.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/ui.draggable.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/ui.resizable.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/ui.dialog.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/effects.core.js"></script>
	<script type="text/javascript" src="scripts/development-bundle/ui/effects.highlight.js"></script>
	<script>
  ...
  'addLinkId': true
	...
	function adicionaPessoaIndividual(codMateria,codPessoa){
		document.cadMateriaBI.action = "cadmateriabi.php?codMateriaBIAtual="+codMateria+"&codTipoBol=<?=$codTipoBol?>&tab=1";
	...
	function excluiPessoaMateria(codMateria,codPessoa){
		document.cadMateriaBI.action = "cadmateriabi.php?codMateriaBIAtual="+codMateria+
										"&codTipoBol=<?=$codTipoBol?>&tab=1";
		document.cadMateriaBI.executar.value = "excluiMilitarIndividual";
		document.cadMateriaBI.codPessoaIndividual.value = codPessoa;
		document.cadMateriaBI.submit();
//		document.getElementById('tabpessoa').tabShow(1);
	}
...
//		alert(url);
	...
	function salvaMateriaBI(acao,codMateria){
		//window.alert(acao);
		document.cadMateriaBI.btnSalvar.value = acao;
...
//		$materiaBi->setUsuario($apresentacao->getUser()); // Rev 05 - Mai2008
		...
		if ($_POST['executar'] == 'salvaTextoIndividual'){
			...
			$getCodMateria = $_GET['codMateriaBIAtual'];
                        echo "pessoa: ".$codPessoa."textoindiv: ".$textoIndividual;
			$PessoaMateriaBI = $fachadaSist2->lerPessoaMateriaBI($getCodMateria,$codPessoa);
			$PessoaMateriaBI->SetTextoIndiv($textoIndividual);
	...
	<input name="texto_individual" type="hidden" value="">
	...
	<div class="tabber" id="mytab1">
	 ...
	 <!-- Abre o 2o tabber -->
	 <? if ($buscaMateria){
	 		echo '<div class="tabbertab" align="center" id="tabpessoa" tabbertabdefault><h2>Militares</h2>';
			...
			echo '<table border="0"  width="810" class="lista">
				...
				echo '<input type="button" name="btnCancelar" value="Cancelar" onClick="cancelar()">';
