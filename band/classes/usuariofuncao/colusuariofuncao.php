...
//      $funcaoDoSistema->setDescricao($row['descricao']);
    ...
    public function lerColecaoAutorizada($login, $assocTipoBol)//alterado
    { $q = "select usuariofuncao.codigofuncao, login, descricao, assoc_tipobol, funcoesdosistema.ativado from usuariofuncao, funcoesdosistema ";
	  $q = $q . " where login = '" . $login . "' and funcoesdosistema.ativado = 'S'" ;
    ...
    { $q = "select funcoesdosistema.codigofuncao, funcoesdosistema.descricao from funcoesdosistema ";
      $q = $q . " where funcoesdosistema.ativado = 'S' AND funcoesdosistema.codigofuncao not in ";
