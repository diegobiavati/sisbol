...
class meuhtml2fpdf extends FPDF
{
//internal attributes
var $HREF; //! string
var $pgwidth; //! float
...
//---Código inserido
  ...
  public function meuhtml2fpdf($orientation='P',$unit='mm',$format='a4', $pagInicial, $tipoBol, $boletim,
  							$pGradAssina, $militarAssina, $funcaoAssina, $om)
...
function Header($content='')
{
	...
	if ($this->PageNo() <> 1)
	{
	    ...
	    $this->Cell(150,5,'(Continuação do ' .  $this->tipoBolAbrev . ' Nr ' . $this->nrBi . $this->biRef . ', de ' . $this->dataBi . 
					', do(a) ' . $this->om . ')',0,0,'L');
...
/// HTML parser ///
///////////////////
function WriteHTML($html,$leftMargin=15.5)
{
//! @desc HTML parser
//! @return void
/* $e == content */
