...
<body><center>
	...
	<h3 class="titulo">&nbsp;&nbsp;<img src="./imagens/item_dir.gif" alt="">&nbsp;Cadastro de Posto e Graduações</h3>
	...
	<?php
      ...
      { echo '<table width="600" border="0" >';
	    ...
	    echo '<img src="./imagens/seta_dir.gif" border=0 alt="">&nbsp;<FONT COLOR="#0080C0">Adicionar</FONT></a>';
	    echo '</TD>';
	    echo '</TR>';
	    echo '</TABLE>';
	  }
	?>
	<table width="600px" border="0" cellspacing="0" cellpadding="0" class="lista"><tr><td>
		...
		if (isset($_POST['executar'])){
		  ...
		  while ($pGrad != null){
			...
			echo '<tr id='.$ord.' onMouseOut="outLinha('.$ord.')" onMouseOver="overLinha('.$ord.')" bgcolor="#F5F5F5">
				...
				<td align="center">
				<a href="javascript:carregaedit('.$pGrad->getCodigo().',\''.$pGrad->getDescricao().'\',\'Alterar\','.$ord.')">';
    		...
    		echo '<a href="javascript:carregaedit('.$pGrad->getCodigo().',\''.$pGrad->getDescricao().'\',\'Excluir\','.$ord.')">';
            ...
            { echo '<img src="./imagens/excluir.png" title="Excluir" border=0 alt="">';
            }
			echo '</a></td></tr>';
