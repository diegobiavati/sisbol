...
<head>
	...
	function executa(acao){
		...
		if (document.cadQM.cod.value == ""){
			window.alert("Informe o código da Qualificação Militar!");
			return;
		}
			...
			window.alert("Informe o nome da Qualificação Militar!");
			return;
		}  
                
		if (acao == "Excluir")  {
			if (!window.confirm("Deseja realmente excluir a Qualificação Militar ?")){
				return ;
			}
		} 
...
<body><center>
	...
	Cadastro de Qualificação Militar <img src="imagens/ajuda.png" width="14" height="14" onClick="ajuda('cadQM')" onMouseOver="this.style.cursor='help';" onMouseOut="this.style.cursor='default';" ></h3>
	<?
...
//	    echo '</TABLE>';
	...
	<tr class="cabec">
		...
		<td width="6%"><div align="center"><strong><font size="2">Cód</font></strong><a href="javascript:ordena('cod')"></a></div></td>
		<td width="47%" align="center"><strong><font size="2">Descrição</font></strong><a href="javascript:ordena('descricao')"></a></td>
		<td width="7%" align="center"><strong><font size="2">Abreviação</font></strong><a href="javascript:ordena('abreviacao')"></a></td>
        <td width="5%" align="center"><strong><font size="2">Ação</font></strong></td>
		</tr>
	<?
	$items_lidos = 0;
	$ord = 0;
