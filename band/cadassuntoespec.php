...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function executa(acao){
				...
				var letrasvalidas = priletra.search("[^A-Za-z0-9( ]"); 
	...
	{ 
		...
		return false; 
                ...
                //PARREIRA - 17-06-13 - Impede erro de cadastro de assunto especÌfico sem assunto geral associado 
                if (document.cadAssuntoEspec.seleAssuntoGeral.value == ""){
                    window.alert("N„o h· Assunto Geral associado a essa seÁ„o do BI");
                    return;
                }
                else {
    ...
    <body><center>
              ...
              <table width="750px" border="0" cellspacing="4" bgcolor="#F5F5F5" style="border-top:1pt solid green;border-bottom:1pt solid green;border-left:1pt solid green;border-right:1pt solid green;">
                ...
                <div id="tabs">                      
                  <ul>
                        ...
                        $outros = "";
                        while ($letras != null) {	
							/*preg_replace modificado por ASP PARREIRA - 24/04/2013
							  preg_replace converte parenteses para underline, inserir outros conforme necessidade*/
							$letra = preg_replace("[^a-zA-Z0-9(-)_]", "", strtr($letras->getDescricao(), "·‡„‚ÈÍÌÛÙı˙¸Á¡¿√¬… Õ”‘’⁄‹«( " , "AAAAEEIOOOUUCAAAAEEIOOOUUC-_"));
          ...
          <?
                        ...
                        while ($assuntoEspec != null) {
							...
							//echo 'letra'.$letra.'<br>';
							$letra = preg_replace("[^a-zA-Z0-9(-)_]", "", strtr($letra, "·‡„‚ÈÍÌÛÙı˙¸Á¡¿√¬… Õ”‘’⁄‹«( ", "AAAAEEIOOOUUCAAAAEEIOOOUUC-_"));
