...
//			}
	...
	<h3 class="titulo">&nbsp;&nbsp;<img src="./imagens/item_dir.gif" alt="">&nbsp;Elaboração de Nota para Boletim</h3>
				...
				if (($_SESSION['APROVNOTA1']=='S')&&($_SESSION['APROVNOTA2']=='S'))
				{
					if (($Materia_BI->getAprovada() == 'N') || ($Materia_BI->getAprovada() == 'E')){
						echo '<a href="javascript:conclui('.$Materia_BI->getCodigo().',\'Concluir\')">
							<img src="./imagens/nok.png"  border=0 title="Enviar para aprovação"><FONT COLOR="#000000"></FONT></a>';
					}else{
						echo '&nbsp;-&nbsp;';
					}
					echo '&nbsp;|&nbsp;';
...
//				if ((($_SESSION['APROVNOTA1']=='N')&&($_SESSION['APROVNOTA2']=='S'))||(($_SESSION['APROVNOTA1']=='S')&&($_SESSION['APROVNOTA2']=='N')) )
	...
	{
		echo '<img src="imagens/nok.png" width="14" height="14"> Enviar para Aprovação';
	}
	?>
