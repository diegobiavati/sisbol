...
<center>
  <? 	$apresentacao->chamaCabec();
		...
		function sistema($data,$php_versao,$mysql_versao,$so){
			global $apresentacao;
			echo '<B><font face="Helvetica" size="4">&nbsp;Sistema</font></B>
				<ul>
                                <font face="Helvetica" size="2"><li><B>Sistema:&nbsp;</B><I>Sistema de Boletins e Alterações</I></li>
  ...
  <table width="720" border="0">
    <tr>
      ...
      <td align="right" valign="top"><font face="Helvetica" size="4"><B> 3º Centro de Telemática de Área</B></FONT> <BR>
        <font face="Helvetica" size="3">Rua da Independência, 632 - Cambuci</FONT> <BR>
        <font face="Helvetica" size="3">São Paulo (SP)</FONT> <BR>
        <font face="Helvetica" size="3">Fone (11) 2915-1476 &nbsp&nbsp RITEx 826-1476</FONT> </td>
    </tr>
  </table>
  <table width="720">
    <tr>
      <td><div class="tabber" id="mytab1">
          ...
          <div class="tabbertab" id="Versão 2.5">
            <h2>Versão 2.5</h2>
            <table width="720" border="0" cellspacing="2" cellpadding="0">
              <tr>
                <td valign="TOP" width="50%"><font face="Helvetica" size="4">
                  <?=sistema('junho de 2013','5.4.x','5.5.x',' Linux Debian 7.x / Ubuntu 13.x');?>
                  </font></td>
                <td width="50%" valign="TOP"><B><font face="Helvetica" size="4">&nbsp;Chefia</font></B>
                  <ul>
                    <li><B>Ch do 3º CTA:&nbsp;</B>Cel Ades </li>
                    <li><B>Ch da Div Tec:&nbsp;</B>1º Ten Dias</li>
                  </ul>
                  <B><font face="Helvetica" size="4">&nbsp;Equipe</font></B>
                  <ul>
                    <li><B>Programação</B>
                    <blockquote>
                    ...
                    <blockquote>2&ordm; Ten S Lopes<br>
                    </blockquote></li>
                    <li><B>Design</B>
                    <blockquote>
                      <p>Asp Parreira<br>
	   ...
	   <div class="tabbertab" id="Versão 2.4">
          ...
          <div class="tabbertab" id="Versão 2.2">
            <h2>Versão 2.2</h2>
            <table width="720" border="0" cellspacing="2" >
              <tr>
                <td valign="TOP" width="50%"><font size="2">
