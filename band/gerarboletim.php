...
<script type="text/javascript">
	...
	function gerarboletim(codbol){
		...
		document.gerarbi.action = "gerarboletim.php?codTipoBol="+item+'&TipoBol='+tipoBol;
		document.gerarbi.submit();
	}
	function tipoBol(){
		window.location.href = "gerarboletim.php?codTipoBol="+document.gerarbi.seleTipoBol.value;
...
<center>
  <? 	$apresentacao->chamaCabec();
	    ...
	    if ($_SESSION['NOMEUSUARIO'] == 'supervisor'){
			...
			$colTipoBol = $fachadaSist2->lerColecaoAutorizadaTipoBol($_SESSION['NOMEUSUARIO'], 3031);
	 	}
	...
	?>
  <h3 class="titulo">&nbsp;&nbsp;<img src="./imagens/item_dir.gif" alt="">&nbsp;Regerar Boletim</h3>
  <form  method="post" name="gerarbi" action="">
		...
		$ord = 0;
  		while ($boletim != null){
			...
			echo '<tr id='.$ord.' onMouseOut="outLinha('.$ord.')" onMouseOver="overLinha('.$ord.')" bgcolor="#F5F5F5">
				...
				<img src="./imagens/engrenagem.gif"  border=0 title="Gera Boletim"><FONT COLOR="#000000"></FONT></a></td>';
    ...
    <table width="650" border="0" cellspacing="0" >
      <tr>
        <td><font color="blue">Obs: S&atilde;o listados somente os 10 &uacute;ltimos boletins aprovados e assinados.</font> </td>
      </tr>
    </table>
